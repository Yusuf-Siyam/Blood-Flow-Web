...
<footer class="main-footer">
    <div class="footer-container">
        <div class="footer-brand">
            <h2>BloodFlow</h2>
            <p>Connecting life-savers across the nation. Join us in our mission to ensure no one suffers due to a lack of blood.</p>
        </div>
        ...
        <div class="footer-contact">
            ...
            <p>Phone: 01521703400</p>
            <p>Emergency: +595626526</p>
        </div>
        <div class="footer-social">
            <!-- Social Icons placeholder -->
            <a href="#">Twitter</a> <a href="#">FB</a> <a href="#">YT</a>
        </div>
    </div>
</footer>
...
.footer-container { display: flex; justify-content: space-around; flex-wrap: wrap; max-width: 1200px; margin: auto; }
